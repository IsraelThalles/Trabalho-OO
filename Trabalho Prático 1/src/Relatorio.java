...
public class Relatorio {
	...
	static int relatorio(int a, int b) {
		double nMin=0, soma=0, nMax=0;
		...
		if(arrayNulo) {
	        ...
	        System.out.println("Relatório meteorológico do mês " + a + " do ano " + b + ":");
			for(int i = 0; i < mesAlvo.length; i++) {
		        System.out.println("\tMedia de temperatura do dia "+ (i+1) + ": " + formatador.format(mesAlvo[i]) + " °C");
			}
	        System.out.println("\tMedia de temperatura do mês: " + formatador.format(soma/mesAlvo.length) + " °C");
			System.out.println("\tTemperatura média mínima do mês: " + formatador.format(nMin) + " °C");
			System.out.println("\tTemperatura média máxima do mês: " + formatador.format(nMax) + " °C");
		}
		return Menu.menu();
	}
